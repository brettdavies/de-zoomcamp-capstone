...
# GCP Settings
gcp_project   = "[redacted]" # put your project ID here
...
user = "[redacted]" # this should match the username set by the OS Login (e.g. if first.last@gmail.com is your email, then typically you'll use first.last here)
